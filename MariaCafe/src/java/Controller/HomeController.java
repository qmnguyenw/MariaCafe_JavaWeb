...
public class HomeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Article articleIntroduction = articleDAO.getArticleByID(1);
            Article articleLeft = articleDAO.getArticleByID(3);
            Article articleRight = articleDAO.getArticleByID(4);
            ...
            if (articleIntroduction == null || articleLeft == null || articleRight == null) {
